...
void initAnnuaire() {
  ...
  char json[] = "[[13, 5, 27],[13, 7, 27],[13, 10, 27],[13, 13, 27],[13, 14, 27],[13, 15, 27]]";
...
void afficheResultats() {
  ...
  if(cl==0){
    ligneZero("Pas de réponse à votre demande");
    delay(2000);
    ligneZero(" ");
    minitel.cursor();
    return;
