...
void displayGuideMire() {
  ...
  if (WiFi.status() == WL_CONNECTED) {
    ...
    minitel.print("la commu du minitel");  
    minitel.attributs(FOND_NORMAL);

    setupWS(22, 16, NB_LOCAL_SERVICES + 1);
  }  
  minitel.cursor();
}
