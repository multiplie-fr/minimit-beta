      ...
      case CORRECTION:
        {
          ...
          String acorriger = (const char*)myObject["input"][currentLine]+userInput;
      ...
      case ENVOI:
        {
          ...
          if (!file) {
            ...
            //myconfig["pseudo"] = (const char*)myObject["input"][2];//Ne pas le mettre la, mais quand lepseudo sera ok
            file.print(myconfig);
            myConfig = myconfig;
            ...
            // Semble poser quelques soucis : on perd le SSID

            checkWifi();
            Serial.println("sortie de loopConfig");
            return;
          }
        }
        break;
